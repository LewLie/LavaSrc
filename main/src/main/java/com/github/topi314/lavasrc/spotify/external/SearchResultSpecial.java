 ...
 */
@JsonDeserialize(builder = SearchResultSpecial.Builder.class)
public class SearchResultSpecial extends AbstractModelObject implements IArtistTrackModelObject, ISearchModelObject {
  private final Paging<AlbumSimplifiedSpecial> albums;
  ...
  private SearchResultSpecial(final Builder builder) {
    super(builder);
   ...
   */
  public Paging<AlbumSimplifiedSpecial> getAlbums() {
    return albums;
  }
  ...
  /**
   * Builder class for building {@link SearchResultSpecial} instances.
   */
  public static final class Builder extends AbstractModelObject.Builder {
    private Paging<AlbumSimplifiedSpecial> albums;
     ...
     * @return A {@link SearchResultSpecial.Builder}.
     */
    public Builder setAlbums(Paging<AlbumSimplifiedSpecial> albums) {
      this.albums = albums;
      return this;
    }
    ...
    @Override
    public SearchResultSpecial build() {
      return new SearchResultSpecial(this);
    }
  }

  /**
   * JsonUtil class for building {@link SearchResultSpecial} instances.
   */
  public static final class JsonUtil extends AbstractModelObject.JsonUtil<SearchResultSpecial> {
    public SearchResultSpecial createModelObject(JsonObject jsonObject) {
      if (jsonObject == null || jsonObject.isJsonNull()) {
        return null;
      }

      return new SearchResultSpecial.Builder()
        .setAlbums(
          hasAndNotNull(jsonObject, "albums")
            ? new AlbumSimplifiedSpecial.JsonUtil().createModelObjectPaging(
